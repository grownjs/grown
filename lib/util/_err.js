...
<div is-error>
  ...
  ${isDev && Object.keys($.context.state) > 3 ? `<details class="call olive">
  ...
  ${isDev ? `<details class="call maroon">
...
module.exports = $ =>
  ($.type === 'html'
    ? renderHtml($, $.env === 'development')
    : renderText($, $.env === 'development'));
