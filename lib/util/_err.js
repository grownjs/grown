...
<div is-error>
  <div class="call">
    ...
    ${$.error.call && $.context.env.NODE_ENV === 'development' ? `<p class="call push">
      <span>${
  ...
  ${$.context.env.NODE_ENV === 'development' ? `<details class="call olive">
    <summary>locals</summary>
    <dl>
      ${Object.keys($.context.resp_locals)
        .filter(x => $.context.resp_locals[x] !== $.context[x] && typeof $.context.resp_locals[x] !== 'function')
        .map(key =>
  ...
  ${$.error.stack && $.context.env.NODE_ENV === 'development' ? `<details class="call red">
    <summary>stack</summary>
    <ul>${dirs($.error.stack)}</ul>
  </details>` : ''}

  ${$.error.errors.length && $.context.env.NODE_ENV === 'development' ? `<details class="call">
  ...
  ${$.context.env.NODE_ENV === 'development' ? `<details class="call maroon">
  ...
  ${$.context.env.NODE_ENV === 'development' ? `<details class="call purple">
    <summary>env</summary>
    <dl>
