...
<div is-error>
  <div class="call">
    ...
    ${$.error.call && $.context.config('env') === 'development' ? `<p class="call push">
      <span>${
  ...
  ${$.context.config('env') === 'development' ? `<details class="call olive">
  ...
  ${$.error.stack && $.context.config('env') === 'development' ? `<details class="call red">
    <summary>stack</summary>
    <ul>${dirs($.error.stack)}</ul>
  </details>` : ''}

  ${$.error.errors.length && $.context.config('env') === 'development' ? `<details class="call">
  ...
  ${$.context.config('env') === 'development' ? `<details class="call maroon">
  ...
  ${$.context.config('env') === 'development' ? `<details class="call purple">
    <summary>env</summary>
    <dl>
