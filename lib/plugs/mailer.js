...
module.exports = args => {
  ...
  return $ => {
    const _mailers = $.extensions('Conn._.mailers');
    ...
    function _view(tpl, _context) {
      ...
      return Promise.resolve()
        .then(() => {
          ...
          const Mailer = util.load(_mailers, _handlers[tpl], tpl);
    ...
    function _send(tpl, locals, _transport) {
      ...
      return Promise.resolve()
        ...
        .then(_locals => {
          ...
          return _render({ src: tpl, data: _locals }, _context)
