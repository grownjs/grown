              ...
              return Promise.resolve()
                .then(() => {
                  ...
                  if (_model) {
                    ...
                    conn.put_local('$routes', _mappings);
                    conn.put_local('$model', _model.name);
                    ...
                    switch (_handler.action) {
                      ...
                      case 'edit':
                        return _model.findOne({
                          ...
                          .then(data => {
                            ...
                            conn.put_local('$actions', {
                              update: {
                                url: _mappings.update.url(conn.params.id),
                                method: _mappings.update.verb,
                              },
                              delete: {
                                url: _mappings.destroy.url(conn.params.id),
                                method: _mappings.destroy.verb,
                              },
                            });
                          });

                      // FIXME: more actions w/ validation?
                      ...
                      case 'create':
                        console.log('CREATE', conn.params);
                        return conn.end('CREATE');

                      case 'destroy':
                        console.log('DESTROY', conn.params);
                        return conn.end('DESTROY');
