...
module.exports = args => {
  ...
  return $ => {
    ...
    $.extensions.resources = _resources;
      ...
      before_send() {
        ...
        this.put_local('is', (route, yes, no) => {
          ...
          if (typeof route === 'string') {
            if (this.handler.path === this.request_path) {
              return this.request_path.indexOf(route) === 0
                ? yes
                : no;
            }
        ...
        action(value) {
          ...
          function print(routes, depth) {
            Object.keys(routes).forEach(k => {
              ...
              /* istanbul ignore else */
              if (!x || Array.isArray(x) || typeof x !== 'object' || !x.handler) {
                return;
              }
              ...
              if (!_filter || _lookup.indexOf(_filter) > -1) {
                ...
                const _tabs = new Array(depth * 2).join(' ');
