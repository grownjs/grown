...
module.exports = function $render() {
  ...
  function _render(view, util, vars) {
    const _id = view.src;
    ...
    $.mount('render', (conn) => {
      conn.before_send(() => {
        ...
        if (conn.handler && conn.handler._controller && conn.handler._controller.instance) {
          ...
          debug(`Reduce views from '${conn.handler.controller}.${conn.handler.view}'`);
        ...
        debug(`Rendering ${_chunks.length} chunks`);
