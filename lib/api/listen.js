...
module.exports = (container) => {
  container.context.listen = (location, options, callback) => {
    const _context = container.context;
    const _server = {};
    ...
    _protocolName = _server.location.protocol.substr(0, _server.location.protocol.length - 1);
