...
module.exports = function $listen(location, params, cb) {
  const _server = this._ctx.util.extend({}, this._ctx.extensions('Conn._'));

  params = !params || typeof params === 'function' ? {} : params;
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      if (!this._servers[_server.port]) {
        this._servers[_server.port] = serverFactory.call(this, _server, params, done);
      } else {
