          ...
          return Promise.resolve()
            ...
            .then(_body => {
              ...
              if (_body && _body !== null && typeof _body.pipe === 'function') {
                debug('#%s Done. Response body is an stream. Sending as application/octet-stream', this.pid);
              ...
              if (_body !== null && Buffer.isBuffer(_body)) {
                debug('#%s Response body is a buffer. Sending as application/octet-stream', this.pid);
