    ...
    return {
      ...
      methods: {
        ...
        raise(code, message) {
          ...
          debug('#%s Done. Trying to flush the response', this.pid);
          ...
          return Promise.resolve()
            ...
            .then(_body => {
              ...
              debug('#%s Done. Trying to send the final response', this.pid);
...
module.exports = ($, _server, req, res) => {
  ...
  $ctx.extensions.forEach(mixin => {
    ...
    if (mixin.before_send) {
      ...
      const cb = mixin.before_send;

      delete mixin.before_send;
