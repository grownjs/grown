  ...
  init(container, server, req, res) {
    ...
    return {
      props: {
        ...
        set resp_body(value) {
          /* istanbul ignore else */
          if (!((value instanceof Buffer) || (typeof value.pipe === 'function')
...
module.exports = (container, server, req, res) => {
  return $new('Homegrown.conn')(container, server, req, res);
};
