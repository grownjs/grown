        ...
        json(value) {
          ...
          return Promise.resolve()
            ...
            .then(_body => {
              ...
              const _type = _state.type || 'application/octet-stream';

              /* istanbul ignore else */
              if (_body && _body !== null && typeof _body.pipe === 'function') {
                debug('#%s Done. Response body is an stream. Sending as %s', this.pid, _type);
              ...
              if (_body !== null && Buffer.isBuffer(_body)) {
                debug('#%s Response body is a buffer. Sending as %s', this.pid, _type);
                ...
                try {
                  ...
                  e.summary = 'Cannot serialize json as response body';
                  throw e;
                }
              }
